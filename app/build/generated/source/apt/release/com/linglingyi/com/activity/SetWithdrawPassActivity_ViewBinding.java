...
public class SetWithdrawPassActivity_ViewBinding implements Unbinder {
  private SetWithdrawPassActivity target;
  ...
  @UiThread
  public SetWithdrawPassActivity_ViewBinding(SetWithdrawPassActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SetWithdrawPassActivity_ViewBinding(final SetWithdrawPassActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SetWithdrawPassActivity target = this.target;
