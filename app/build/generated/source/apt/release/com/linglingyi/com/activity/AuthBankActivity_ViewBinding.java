...
public class AuthBankActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public AuthBankActivity_ViewBinding(AuthBankActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AuthBankActivity_ViewBinding(final AuthBankActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AuthBankActivity target = this.target;
