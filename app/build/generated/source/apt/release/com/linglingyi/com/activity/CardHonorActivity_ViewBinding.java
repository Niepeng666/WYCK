...
public class CardHonorActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CardHonorActivity_ViewBinding(CardHonorActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CardHonorActivity_ViewBinding(final CardHonorActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CardHonorActivity target = this.target;
