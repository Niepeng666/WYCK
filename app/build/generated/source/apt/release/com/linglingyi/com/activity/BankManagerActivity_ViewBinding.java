...
public class BankManagerActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public BankManagerActivity_ViewBinding(BankManagerActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public BankManagerActivity_ViewBinding(final BankManagerActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    BankManagerActivity target = this.target;
