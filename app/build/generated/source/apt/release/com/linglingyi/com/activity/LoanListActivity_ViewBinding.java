...
public class LoanListActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public LoanListActivity_ViewBinding(LoanListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public LoanListActivity_ViewBinding(final LoanListActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LoanListActivity target = this.target;
