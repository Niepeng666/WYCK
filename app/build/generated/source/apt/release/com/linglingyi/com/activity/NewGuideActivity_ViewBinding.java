...
public class NewGuideActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public NewGuideActivity_ViewBinding(NewGuideActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public NewGuideActivity_ViewBinding(final NewGuideActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    NewGuideActivity target = this.target;
