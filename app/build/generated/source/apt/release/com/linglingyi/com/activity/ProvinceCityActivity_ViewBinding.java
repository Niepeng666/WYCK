...
public class ProvinceCityActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ProvinceCityActivity_ViewBinding(ProvinceCityActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ProvinceCityActivity_ViewBinding(final ProvinceCityActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ProvinceCityActivity target = this.target;
