...
public class ChoiceAreaActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ChoiceAreaActivity_ViewBinding(ChoiceAreaActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ChoiceAreaActivity_ViewBinding(final ChoiceAreaActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChoiceAreaActivity target = this.target;
