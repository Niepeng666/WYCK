...
public class PreviewCardsDetailActivity_ViewBinding implements Unbinder {
  private PreviewCardsDetailActivity target;
  ...
  @UiThread
  public PreviewCardsDetailActivity_ViewBinding(PreviewCardsDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PreviewCardsDetailActivity_ViewBinding(final PreviewCardsDetailActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PreviewCardsDetailActivity target = this.target;
