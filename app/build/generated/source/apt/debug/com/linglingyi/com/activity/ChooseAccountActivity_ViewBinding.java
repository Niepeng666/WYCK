...
public class ChooseAccountActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ChooseAccountActivity_ViewBinding(ChooseAccountActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ChooseAccountActivity_ViewBinding(final ChooseAccountActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChooseAccountActivity target = this.target;
