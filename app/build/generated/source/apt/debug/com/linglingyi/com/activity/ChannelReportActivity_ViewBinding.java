...
public class ChannelReportActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ChannelReportActivity_ViewBinding(ChannelReportActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ChannelReportActivity_ViewBinding(final ChannelReportActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChannelReportActivity target = this.target;
