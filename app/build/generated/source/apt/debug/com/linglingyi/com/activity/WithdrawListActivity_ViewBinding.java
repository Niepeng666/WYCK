...
public class WithdrawListActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public WithdrawListActivity_ViewBinding(WithdrawListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public WithdrawListActivity_ViewBinding(final WithdrawListActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    WithdrawListActivity target = this.target;
