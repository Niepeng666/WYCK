package com.linglingyi.com.viewone.wheelview;

/**
 * Created by 毅明 on 2017/12/25.
 *
 */
...
import com.linglingyi.com.viewone.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
    ...
    private String strArea = "滨江区";
    private OnAddressCListener onAddressCListener;

    private int maxsize = 14;
    private int minsize = 12;

    public ChangeAddressPopwindow(final Context context, boolean flog) {
        super(context);
